...
| Testing | ~50% (89 unit tests + 22 CI jobs, incl. fifteen headless boot self-tests, TLA+ model checking, and FFI property/differential fuzzing; no coverage-guided fuzz or deep integration) |

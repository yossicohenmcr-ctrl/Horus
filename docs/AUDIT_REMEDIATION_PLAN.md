...
| 4 | **I6/I7** | docs | One source of truth for CI job/test counts (README/SECURITY/LIMITATIONS disagreed; CI has 20 jobs, 62 unit tests). TESTS.md is now canonical and `tools/check_doc_counts.sh` gates drift in CI. Moved `docs/security_report.md` → `.github/ISSUE_TEMPLATE/`. | docs |

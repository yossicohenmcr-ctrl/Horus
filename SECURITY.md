...
| Testing | ~50% (89 unit tests + 22 CI jobs, incl. headless self-tests, TLA+ model checking, and FFI fuzzing; no coverage-guided fuzz or deep integration) |
